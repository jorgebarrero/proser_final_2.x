...
@Component({
  selector: 'app-reports-automaitc-report',
  templateUrl: './automaitc-report.component.html',
  styleUrls: ['./automaitc-report.component.scss']
})
export class AutomaitcReportComponent implements OnInit {
  ...
  constructor(
    ...
    this.title = "Llamadas automáticas";
  }
