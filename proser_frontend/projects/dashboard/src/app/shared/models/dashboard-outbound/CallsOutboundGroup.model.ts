export class CallsOutboundGroupModel {
  group_name: string;
  group_id: string;
  ...
  public fieldList() {
    return [
      { field_name: "group_name", name: "nombre_grupo", text: "Grupo" },
      { field_name: "group_id", name: "id_grupo", text: "Id" },
      { field_name: "group_item_name", name: "item_grupo", text: "Item" },
