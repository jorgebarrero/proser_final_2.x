export class DashboardAutomaticModel {
  ...
  dashboardAutomaticCurrentCallsInicators;
  agentsPlannedTotal;
  ...
  constructor() {
    ...
    this.dashboardAutomaticCurrentCallsInicators = '';
  ...
  public fieldList() {
    return [
      ...
      { field_name: "dashboardAutomaticCurrentCallsInicators", name: "indicadores_llamadas_actuales", text: "Llamadas actuales" },
