...
export class ReportsDataService {
  ...
  getAuditList(userSelection: UserSelectionModel): Observable<any> {
    ...
    const url_api = `${this.env.loopbackApiUrl}/api/InvReports/dataAuditReport?access_token=${accessToken}`;
    const res = this.http
  ...
  getCdrList(userSelection): Observable<any> {
    ...
    const url_api = `${this.env.loopbackApiUrl}/api/InvReports/dataCdrReport?access_token=${accessToken}`;
  ...
  getCallEntryList(userSelection): Observable<any> {
    ...
    const url_api = `${this.env.loopbackApiUrl}/api/InvReports/dataCallEntryReport?access_token=${accessToken}`;
    const res = this.http.post(url_api, userSelection, {
      headers: this.headers
    });
