...
export class ProShowDisplayService {
  api_string = "/api/ProShowDisplays";
  ...
  getAllRecords(query?): Observable<ProShowDisplayModel[]> {
    ...
    return this.http
      .get<ProShowDisplayModel[]>(url_api, { headers: this.headers })
      .pipe(
        map(data => data),
  ...
  postRecord(item?) {
    ...
    return this.http
      .post<ProShowDisplayModel>(url_api, query, { headers: this.headers })
      .pipe(map(data => data));
  }
  ...
  putRecord(item?) {
    ...
    return this.http
      .put<ProShowDisplayModel>(url_api, query, { headers: this.headers })
      .pipe(map(data => data));
  }
  ...
  deleteRecord(id) {
    ...
    const url_api = `${this.env.loopbackApiUrl}${this.api_string}/${id}?&access_token=${accessToken}`;
    return this.http
      .delete<ProShowDisplayModel>(url_api, id)
      .pipe(map(data => data));
  }
  ...
  getRecordById(id) {
    ...
    const url_api = `${this.env.loopbackApiUrl}${this.api_string}/${id}?access_token=${accessToken}`;
    return this.http
      .get<ProShowDisplayModel>(url_api, id)
      .pipe(map(data => data));
  }
}
