...
export async function dashboardInboundIndicators(userSelection) {
  ...
  let dashboardInboundCurrentCallsInicators = await dashboardInboundCurrentCallsInicatorsFunction(
    userSelection
  );
  ...
  let colors = [
    {
      ...
      callsOnQueue: onColorForCallsOnQueue(
        dashboardInboundCurrentCallsInicators[0].maxWaitTimeOnQue,
  ...
  result = {
    ...
    dashboardInboundCurrentCallsInicators,
    agentsPlannedTotal,
...
/**************************************** */
// current calls
async function dashboardInboundCurrentCallsInicatorsFunction(userSelection) {
  let result = null;
  let resume_error = false;
  let query = `
-- dashboardInboundCurrentCallsInicatorsFunction --------------
-- FIELDS
SELECT
