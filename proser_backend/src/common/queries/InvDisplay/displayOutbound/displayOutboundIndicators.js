...
export async function displayOutboundIndicators(userSelection) {
  ...
  let displayOutboundCurrentCallsInicators = await displayOutboundCurrentCallsInicatorsFunction(
    userSelection
  );
  ...
  let colors = [
    {
      ...
      callsOnQueue: onColorForCallsOnQueue(
        displayOutboundCurrentCallsInicators[0].maxWaitTimeOnQue,
  ...
  result = {
    ...
    displayOutboundCurrentCallsInicators,
    agentsPlannedTotal,
...
/**************************************** */
// current calls
async function displayOutboundCurrentCallsInicatorsFunction(userSelection) {
  let result = null;
  let resume_error = false;
  let query = `
